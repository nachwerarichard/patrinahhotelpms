...
type RRuleTemporalIterator = (date: TemporalZonedDateTime, i: number) => boolean;
...
type RRuleOptions = ManualOptions | IcsOptions;
type RRuleResolvedOptions = Omit<ManualOptions, 'dtstart' | 'until' | 'rDate' | 'exDate'> & {
...
declare class RRuleTemporal {
  ...
  private static toInternalIterator;
  private static toPublicDate;
  private static toPublicDates;
   ...
   */
  between(after: DateFilter, before: DateFilter, inc?: boolean): TemporalZonedDateTime[];
  /**
   ...
   */
  next(after?: DateFilter, inc?: boolean): TemporalZonedDateTime | null;
  /**
   ...
   */
  previous(before?: DateFilter, inc?: boolean): TemporalZonedDateTime | null;
  toString(): string;
...
//#endregion
export { DateFilter, Freq, RRuleOptions, RRuleResolvedOptions, RRuleTemporal, RRuleTemporalIterator, TemporalPlainDate, TemporalPlainDateInput, TemporalZonedDateTime, TemporalZonedDateTimeInput, Weekday, allowedFreq, allowedWeekdays, weekdayToIsoDay };