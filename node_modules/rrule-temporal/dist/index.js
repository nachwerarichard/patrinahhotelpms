...
var RRuleTemporal = class RRuleTemporal {
	...
	*/
	mergeAndDeduplicateRDates(dates) {
		...
		const dedup = [];
		for (const d of dates) if (dedup.length === 0 || Temporal.ZonedDateTime.compare(d, dedup[dedup.length - 1]) !== 0) dedup.push(d);
		return dedup;
	}
	/**
...
//#endregion
export { RRuleTemporal, allowedFreq, allowedWeekdays, weekdayToIsoDay };
