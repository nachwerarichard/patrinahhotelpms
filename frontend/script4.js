...
actionButtonsHtml = `
    ...
    <button class="${baseBtn} bg-blue-500 hover:bg-blue-600" onclick="editBooking('${booking.id}')">Edit</button>
                        <button class=" ${baseBtn} btn btn-secondary" onclick="viewCharges('${booking.id}')">View Charges</button>
    ...
    <i class="fa-solid fa-money-bill-wave mr-1"></i> Add Payment
                            ...
                            <button class=" ${baseBtn} btn btn-info" onclick="printReceipt('${booking.id}')"><i class="fas fa-print"></i> Receipt</button>
